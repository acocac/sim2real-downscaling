...
paths = Paths(
    ...
    raw_era5=f"{root}/data/uk/hourly/raw/era5/swval1_era5land.nc",
    era5=f"{root}/data/uk/hourly/processed/era5/swval1_era5land.nc",
    lsm_raw=f"{root}/data/uk/hourly/raw/era5/lsm_era5land.nc",
    lsm_processed=f"{root}/data/uk/hourly/processed/era5/lsm_era5land.nc",
